export interface RaceData {
  name: string;
  category: 'core' | 'humanoid' | 'monstrous' | 'dragon' | 'aberration' | 'outsider' | 'undead' | 'construct' | 'elemental' | 'fey' | 'giant' | 'magical-beast' | 'ooze' | 'plant' | 'vermin' | 'psionic';
...
export const races: Record<string, RaceData> = {
  ...
  dromite: {
    name: 'Dromite',
    category: 'psionic',
    abilityAdjustments: { charisma: 2, strength: -2, wisdom: -2 },
    size: 'small',
    speed: 20,
    specialAbilities: [
      'Small size: +1 AC, +1 attack, +4 Hide',
      'Natural armor +3',
      'Energy resistance 5 (choice at creation)',
      'Scent ability',
      'Psi-like ability: energy ray 1/day',
      'Blind-fight as bonus feat',
      'Compound eyes: +2 on Spot checks',
    ],
    automaticLanguages: ['Common', 'Dromite'],
    bonusLanguages: ['Dwarven', 'Gnome', 'Goblin', 'Terran'],
    favoredClass: 'Wilder',
    levelAdjustment: 1,
  },
  duergar: {
    ...
    category: 'psionic',
    abilityAdjustments: { constitution: 2, charisma: -4 },
    size: 'medium',
    speed: 20,
    specialAbilities: [
      'Darkvision 120 ft',
      ...
      'Psi-like abilities: expansion, invisibility 1/day each',
      'Light sensitivity: -1 attack in bright sunlight',
      'Stonecunning: +2 on Search checks related to stone',
      'Stability: +4 vs bull rush/trip',
      '+1 on attack vs orcs and goblinoids',
    ...
    bonusLanguages: ['Draconic', 'Giant', 'Goblin', 'Orc', 'Terran'],
    favoredClass: 'Fighter',
    levelAdjustment: 1,
  },
  elan: {
    name: 'Elan',
    category: 'psionic',
    abilityAdjustments: { charisma: -2 },
    size: 'medium',
    speed: 30,
    specialAbilities: [
      'Aberration type (not humanoid)',
      'Naturally psionic: +2 power points at 1st level',
      'Resistance (Su): Spend 1 PP for +4 on saving throws',
      'Resilience (Su): Reduce damage by 2 for 1 PP',
      'Repletion (Su): Spend 1 PP to not need food/water for 24 hours',
    ],
    automaticLanguages: ['Common'],
    bonusLanguages: ['Any'],
    favoredClass: 'Psion',
  ...
  'half-giant': {
    name: 'Half-Giant',
    category: 'psionic',
    abilityAdjustments: { strength: 2, constitution: 2, dexterity: -2 },
    size: 'medium',
    speed: 30,
    specialAbilities: [
      'Giant type',
      'Powerful build: functions as Large when beneficial',
      'Fire acclimated: +2 on saves vs fire',
      'Naturally psionic: +2 power points at 1st level',
      'Psi-like ability: stomp 1/day',
      'Low-light vision',
    ],
    automaticLanguages: ['Common'],
    bonusLanguages: ['Draconic', 'Giant', 'Gnoll', 'Ignan'],
  ...
  maenad: {
    ...
    specialAbilities: [
      'Naturally psionic: +2 power points at 1st level',
      'Psi-like ability: energy ray (sonic) 1/day',
      'Outburst (Ex): +2 Str for 4 rounds, 1/day (fatigued after)',
      'Inner rage: spend 1 PP to not be dazed/stunned',
    ],
    automaticLanguages: ['Common', 'Maenad'],
    bonusLanguages: ['Aquan', 'Draconic', 'Dwarven', 'Elven', 'Goblin'],
    favoredClass: 'Wilder',
    levelAdjustment: 0,
  },
  xeph: {
    ...
    specialAbilities: [
      ...
      'Burst (Su): +10 ft speed for 3 rounds, 3/day',
      '+1 on saves vs powers, spells, spell-like abilities',
    ],
    automaticLanguages: ['Common', 'Xeph'],
    bonusLanguages: ['Draconic', 'Elven', 'Gnoll', 'Goblin', 'Halfling', 'Orc', 'Terran'],
